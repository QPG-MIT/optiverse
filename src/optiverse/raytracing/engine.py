...
def trace_rays_polymorphic(
    ...
    for source_index, source in enumerate(sources):
        ...
        for ray in initial_rays:
            ray_jobs.append((ray, elements, max_events, epsilon, min_intensity, source, source_index))
...
def _trace_single_ray_worker(
    ...
    Args:
        args: Tuple containing (ray, elements, max_events, epsilon, min_intensity, source, source_index)
    ...
    return _trace_single_ray(ray, elements, max_events, epsilon, min_intensity, source, source_index)
