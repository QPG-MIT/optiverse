...
class WaveplateItem(BaseObj):
    ...
    def open_editor(self):
        ...
        initial_phase = self.params.phase_shift_deg
        initial_fast_axis = self.params.fast_axis_deg
        ...
        if not result:
            ...
            self.params.phase_shift_deg = initial_phase
            self.params.fast_axis_deg = initial_fast_axis
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> 'WaveplateItem':
        """Static factory method: deserialize from dictionary and return new WaveplateItem."""
