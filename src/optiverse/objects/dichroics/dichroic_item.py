...
class DichroicItem(BaseObj):
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> 'DichroicItem':
        """Static factory method: deserialize from dictionary and return new DichroicItem."""
